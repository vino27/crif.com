...
{
    public partial class DonloadedContents_UserControl : System.Web.UI.UserControl
    {
        ...
        protected void ibDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sqlSelectQuery = String.Format("SELECT [Id],[FirstName],[LastName],[Company],[UserRole] AS Role,[Email],[Telephone],[contentUrl],[ClientIP],[Device],[Browser], " +
                           " [UserAgent],[DevicePlatform],[FormId] as [Page Url],[CreatedDate] FROM[dbo].[DownloadedContents] WHERE ISNULL([IsProduct],0)=0 AND ISNULL([IsSuccessStory],0)=0  ORDER BY CreatedDate DESC", sqlConnection);

...
{
    public partial class ContactDetails_UserControler : System.Web.UI.UserControl
    {
        ...
        protected void ibDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sqlConnection.Open();
            sqlSelectQuery = String.Format("SELECT [Id],[Name],[Surname],[Company],[Email],[Telephone],[Role],[Market],[Nation],[RequestType],[FormId],[Message],[ClientIP],[Device],[Browser], " +
                           " [UserAgent],[DevicePlatform],[CreatedDate] FROM[dbo].[contactUs] ORDER BY CreatedDate DESC", sqlConnection);

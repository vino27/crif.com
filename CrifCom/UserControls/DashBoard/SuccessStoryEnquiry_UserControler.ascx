<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuccessStoryEnquiry_UserControler.ascx.cs" Inherits="CrifCom.UserControls.DashBoard.SuccessStoryEnquiry_UserControler" %>
<div class="block">
        <style type="text/css">
                ...
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                            ...
                            <Fields>
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        ...
                                        <%#Eval("Company")%>
                                        <br /> 
                                         <strong>Success Story Page Url:</strong> 
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[FirstName],[LastName],[Email],[Telephone],[Company],[contentUrl],
                            [FormId],[CreatedDate] FROM [dbo].[DownloadedContents] WHERE [IsSuccessStory]=1 ORDER BY [CreatedDate] DESC"

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DonloadedContents_UserControl.ascx.cs" Inherits="CrifCom.UserControls.DashBoard.DonloadedContents_UserControl" %>
<div class="block">
        <style type="text/css">
                ...
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                            ...
                            <Fields>
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        ...
                                        <%#Eval("Company")%>
                                        <br /> 
                                         <strong>Downloaded Content Url:</strong> 
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[FirstName],[LastName],[Email],[Telephone],[Company],[contentUrl],
                            [FormId],[CreatedDate] FROM [dbo].[DownloadedContents]  WHERE ISNULL([IsProduct],0)=0 AND ISNULL([IsSuccessStory],0)=0 ORDER BY [CreatedDate] DESC"

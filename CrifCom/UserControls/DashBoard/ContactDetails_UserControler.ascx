<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactDetails_UserControler.ascx.cs" Inherits="CrifCom.UserControls.DashBoard.ContactDetails_UserControler" %>
<div class="block">
        <style type="text/css">
            ...
            <td valign="top" width="52%">
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDetails" runat="server" SelectCommand="SELECT [Id],[Name],[Surname],[Email],[Telephone],[Company],[Role],[Market],[Nation],[Message],
                            [CreatedDate] FROM [dbo].[contactUs] WHERE ([Id] = @Id)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="GridView1" Name="id" PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[Name],[Surname],[Email],[Telephone],[Company],[Role],[Market],[Nation],[Message],
                            [CreatedDate]  FROM [dbo].[contactUs] ORDER BY [CreatedDate] DESC"
